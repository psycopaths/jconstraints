...
//			assert tmp.equals("WWWWW's Birthday is 12-17-77");
	...
	public void testConcat() {
		...
		Expression halloWelt = RegexCompoundExpression.createConcat(RegexOperatorExpression.createStrToRe("Hallo"),
	...
	public void testIntegerAndStringMixture() {
		...
		NumericCompound nc1 = new NumericCompound(i,
												  NumericOperator.MINUS,
												  Constant.create(BuiltinTypes.INTEGER, BigInteger.valueOf(1)));
		NumericCompound nc2 = new NumericCompound(Constant.create(BuiltinTypes.INTEGER, BigInteger.valueOf(5)),
												  NumericOperator.MINUS,
												  i);
