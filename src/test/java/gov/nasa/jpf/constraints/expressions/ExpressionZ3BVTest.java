...
public class ExpressionZ3BVTest {
  ...
  public void expressionTest() throws RecognitionException, ImpreciseRepresentationException {
    ...
    BitvectorExpression<Integer> and = BitvectorExpression.create(
            const_63, BitvectorOperator.AND, const_64);
    
    
    NumericBooleanExpression expr = NumericBooleanExpression.create(
            and, NumericComparator.EQ, var_i1);
    ...
    Expression<Boolean> expr2 = new QuantifierExpression(Quantifier.FORALL, Collections.singletonList(var_i2),
    ...
    Expression<Boolean> expr3 = NumericBooleanExpression.create(
