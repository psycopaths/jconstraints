...
import gov.nasa.jpf.constraints.smtlibUtility.solver.SMTLibExportSolverContext;
...
public class SMTLibExportWrapperTest {
    ...
    @Test(groups = {"jsmtlib", "base"})
    public void testSMTLibStringExport() throws IOException, SMTLIBParserException, IParser.ParserException {
