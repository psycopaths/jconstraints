...
public class CastExpressionTest {
	...
	public void castSINT32IntegerTest() {
		...
		CastExpression expr = CastExpression.create(Variable.create(BuiltinTypes.SINT32, "X"), BuiltinTypes.INTEGER);
		se.add(expr);
	...
	public void castIntegerSINT32Test() {
		...
		CastExpression expr = CastExpression.create(Variable.create(BuiltinTypes.INTEGER, "X"), BuiltinTypes.SINT32);
		se.add(expr);
		String output = baos.toString();
		assertEquals(output, expected);
	}
	...
	public void castIntegerSINT8Test() {
		...
		CastExpression expr = CastExpression.create(Variable.create(BuiltinTypes.INTEGER, "X"), BuiltinTypes.SINT8);
		se.add(expr);
		String output = baos.toString();
		assertEquals(output, expected);
	}
	...
	public void castSINT8SINT32Test() {
		...
		CastExpression expr = CastExpression.create(Variable.create(BuiltinTypes.SINT8, "X"), BuiltinTypes.SINT32);
		se.add(expr);
		String output = baos.toString();
		assertEquals(output, expected);
	}
	...
	public void castSINT8UINT16Test() {
		...
		CastExpression expr = CastExpression.create(Variable.create(BuiltinTypes.SINT8, "X"), BuiltinTypes.UINT16);
		se.add(expr);
		String output = baos.toString();
		assertEquals(output, expected);
	}
	...
	public void castUINT16SINT32Test() {
		...
		CastExpression expr = CastExpression.create(Variable.create(BuiltinTypes.UINT16, "X"), BuiltinTypes.SINT32);
		se.add(expr);
		String output = baos.toString();
		assertEquals(output, expected);
	}
