...
public class StringExpressionTest {
	...
	public void substrTest() {
		...
		StringCompoundExpression expr = StringCompoundExpression.createSubstring(var, intConst, intConst);
		Util.runTest(expr, expected);
	}
	...
	public void replaceTest() {
		...
		StringCompoundExpression expr =
				StringCompoundExpression.createReplace(var, constant, Constant.create(BuiltinTypes.STRING, "FOO"));
		Util.runTest(expr, expected);
	}
