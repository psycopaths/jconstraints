...
public abstract class BooleanDoubleFunction extends Function<Boolean> {
  ...
  public static BooleanDoubleFunction DOUBLE_IS_INFINITE = new BooleanDoubleFunction("java.lang.Double.isInfinite") {
    @Override
	...
	public static BooleanDoubleFunction DOUBLE_IS_NAN = new BooleanDoubleFunction("java.lang.Double.isNaN") {
		@Override
		protected boolean doEvaluate(double value) {
