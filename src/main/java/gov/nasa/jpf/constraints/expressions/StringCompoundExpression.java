...
public class StringCompoundExpression extends AbstractStringExpression {
	...
	public static StringCompoundExpression createSubstring(Expression<?> main,
																												 Expression<?> offset,
																												 Expression<?> length) {
	...
	public static StringCompoundExpression createReplace(Expression<?> main, Expression<?> src, Expression<?> dst) {
		return new StringCompoundExpression(main, StringOperator.REPLACE, null, null, null, src, dst, null);
	}

	public static StringCompoundExpression createToLower(Expression<?> main) {
		return new StringCompoundExpression(main, StringOperator.TOLOWERCASE, null, null, null, null, null, null);
	}

	public static StringCompoundExpression createToUpper(Expression<?> main) {
		return new StringCompoundExpression(main, StringOperator.TOUPPERCASE, null, null, null, null, null, null);
	}

	public StringCompoundExpression(Expression<?> main,
