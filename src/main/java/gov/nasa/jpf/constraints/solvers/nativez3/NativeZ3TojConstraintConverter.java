...
public class NativeZ3TojConstraintConverter {
	...
	public Expression parse(Expr z3Expr) throws ImpreciseRepresentationException {
		...
		if (arguments.size() == 2) {
			if (z3Expr.isAdd()) {
				returnExpression = NumericCompound.create(arguments.get(0), NumericOperator.PLUS, arguments.get(1));
			}
			if (z3Expr.isMul()) {
				returnExpression = NumericCompound.create(arguments.get(0), NumericOperator.MUL, arguments.get(1));
			}
			if (z3Expr.isDiv()) {
				returnExpression = NumericCompound.create(arguments.get(0), NumericOperator.DIV, arguments.get(1));
			}
			if (z3Expr.isRemainder()) {
				returnExpression = NumericCompound.create(arguments.get(0), NumericOperator.REM, arguments.get(1));
			}
			if (z3Expr.isSub()) {
				returnExpression = NumericCompound.create(arguments.get(0), NumericOperator.MINUS, arguments.get(1));
			}
			if (z3Expr.isGT()) {
				returnExpression =
						NumericBooleanExpression.create(arguments.get(0), NumericComparator.GT, arguments.get(1));
			}
			if (z3Expr.isGE()) {
				returnExpression =
						NumericBooleanExpression.create(arguments.get(0), NumericComparator.GE, arguments.get(1));
			}
			if (z3Expr.isLT()) {
				returnExpression =
						NumericBooleanExpression.create(arguments.get(0), NumericComparator.LT, arguments.get(1));
			}
			if (z3Expr.isLE()) {
				returnExpression =
						NumericBooleanExpression.create(arguments.get(0), NumericComparator.LE, arguments.get(1));
			}
			if (z3Expr.isEq()) {
				returnExpression =
						NumericBooleanExpression.create(arguments.get(0), NumericComparator.EQ, arguments.get(1));
			}
			if (z3Expr.isModulus()) {
