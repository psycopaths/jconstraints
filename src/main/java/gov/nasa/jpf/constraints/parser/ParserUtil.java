...
public class ParserUtil {
	...
	public static List<Variable<?>> parseVariableDeclaration(String string) throws
			RecognitionException,
			ImpreciseRepresentationException {
	...
	public static Expression<Boolean> parseLogical(String string) throws
			RecognitionException,
			ImpreciseRepresentationException {
	...
	public static Expression<Boolean> parseLogical(String string,
												   TypeContext types,
												   Collection<? extends Variable<?>> variables) throws
			RecognitionException,
			ImpreciseRepresentationException {
		ExpressionParser parser = getParser(string);
		Tree ast = parser.start().tree;
	...
	public static Expression parseArithmetic(String string) throws
			RecognitionException,
			ImpreciseRepresentationException {
